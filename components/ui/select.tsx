...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Trigger
		ref={ref}
		className={cn(
			'flex h-10 w-full text-md items-center justify-between rounded-md border bg-input-primary px-4 py-2 disabled:cursor-not-allowed',
			className
		)}
		{...props}
	>
...
>(({ className, ...props }, ref) => (
	<SelectPrimitive.Separator ref={ref} className={cn('-mx-1 my-1 h-px border', className)} {...props} />
))
